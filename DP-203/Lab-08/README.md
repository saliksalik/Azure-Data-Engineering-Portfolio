...
Before starting, I ensured that Lab 6 was completed. If not, I followed the lab setup instructions to create the required linked services and datasets. Here’s what I did:
